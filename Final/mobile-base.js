...
gauge.add($("NWSGaugeDiv"), {width:20, height:150, name: 'NWSGauge', vertical: true, limit: true, gradient: true, scale: 10, colors:['#E31A1C','#FC4E2A','#FEB24C','#D9F0A3','#C8F60F','#83F60F'], values:[35,10,5,10,10,30,5]});
gauge.add($("MesoGaugeDiv"), {width:20, height:150, name: 'MesoGauge', vertical: true, limit: true, gradient: true, scale: 10, colors:['#E31A1C','#FC4E2A','#E67451','#ADDD8E','#F7FCB9','#C8F60F','#83F60F'], values:[20,20,20,2,5,18,14]});
gauge.add($("DD60GaugeDiv"), {width:20, height:150, name: 'DD60Gauge', vertical: true, limit: true, gradient: true, scale: 10, colors:['#C11B17','#F66F0F','#F6BD0F','#C8F60F','#83F60F'], values:[10,10,10,10,10,10]});
...
var init = function (onSelectFeatureFunction) {
    ...
    var geolocategraphic = new OpenLayers.Layer.Vector("Vector Layer", {});
...
var styleMap = new OpenLayers.StyleMap(OpenLayers.Util.applyDefaults(
        {fillColor: "green", stroke: "true", fillOpacity: 0, strokeColor:'#66FFFF', strokeDashstyle: "solid",strokeWidth:5},
        OpenLayers.Feature.Vector.style["default"]));
var select = new OpenLayers.Layer.Vector("Property Selection",{styleMap: styleMap});    
...
info = new OpenLayers.Control.WMSGetFeatureInfo({
       ...
       DispDate = e.features[0].attributes.DispDate;
//-----------------Gauje Update---------------------------------------------------
   ...
   if (NWSMinTemp <= 35 )  
              ...
              document.getElementById('Label1').style.fontWeight= "bolder";
              }
              ...
              else if (NWSMinTemp > 50  && NWSMinTemp <60 )  
              {
               gauge.modify($('NWSGauge'), {values:[0.35,0.10,0.05,0.10,1]});
                document.getElementById('Label1').style.color = "#003300";
                document.getElementById('Label1').style.fontWeight= "bolder";
              }
             ...
             if (MesoTemp > 1 && MesoTemp <= 20 )  
              ...
              document.getElementById('Label2').style.fontWeight= "bolder";

              }
               else if (MesoTemp == 1 )  
              {
               gauge.modify($('MesoGauge'), {values:[0.10,1]});
               document.getElementById('Label2').value = "N/A";
               document.getElementById('Label2').style.color = "#FF0000";
               document.getElementById('Label2').style.fontWeight= "bolder";
              ...
              else if (MesoTemp >= 65  && MesoTemp < 68 )  
              {
               ...
               document.getElementById('Label2').style.color = "#999900";
               document.getElementById('Label2').style.fontWeight= "bolder";
              ...
              else if (MesoTemp >= 68 )  
              {
               ...
               document.getElementById('Label2').style.color = "#003300";
               document.getElementById('Label2').style.fontWeight= "bolder";
             ...
             if (DD605DayV <= 10 )  
              ...
              document.getElementById('Label3').style.fontWeight= "bolder";

              }
              else if (DD605DayV > 10 && DD605DayV <= 15 )  
              {
               gauge.modify($('DD60Gauge'), {values:[0.20,0.20,1]});
               document.getElementById('Label3').style.color = "#FF3300";
               document.getElementById('Label3').style.fontWeight= "bolder";
              ...
              else if (DD605DayV > 15 && DD605DayV <= 25 )  
              {
               ...
               document.getElementById('Label3').style.color = "#FF6633";
               document.getElementById('Label3').style.fontWeight= "bolder";
              ...
              else if (DD605DayV > 25  && DD605DayV <= 50 )  
              {
               ...
               document.getElementById('Label3').style.color = "#33CC33";
               document.getElementById('Label3').style.fontWeight= "bolder";
              ...
              else if (DD605DayV > 50 )  
              {
               ...
               document.getElementById('Label3').style.color = "#003300";
               document.getElementById('Label3').style.fontWeight= "bolder";
     ...
     document.getElementById("Label1").value = NWSMinTemp + "F" ;
     document.getElementById("Label2").value = MesoTemp + "F";
     document.getElementById("Label3").value = DD605DayV + "HU";
     document.getElementById("Label4").value = FinalRank;
     document.getElementById("Label5").value = DispDate;

 DisplayAlert('popup',250,50);
		$j.mobile.allowCrossDomainPages = true;
         $j.mobile.changePage("#popup", null, true, true);
...
document.getElementById('Label2').value = SoilTemp +"F";
...
var SoilTempRank;
 if (SoilTemp >= 68 && SoilTemp <= 100)
        { 
       document.getElementById('Label4').value = AirCondition;
	...
	{
	   document.getElementById('Label4').value = "Planting NOT recommended due to soil temp at 2 in depth below 68�F at mid morning";
	   SoilTempRank = "No"
	 ...
	 else if(isNaN(SoilTemp)) 
	{
	   ...
	   document.getElementById('Label4').value = "Not Enough Data";
	   SoilTempRank = "##"
	   ...
	   document.getElementById('Label4').value = "Invalid Soil Temp";
	   SoilTempRank = "##"
